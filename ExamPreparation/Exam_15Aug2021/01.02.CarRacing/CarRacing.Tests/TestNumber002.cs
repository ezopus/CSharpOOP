...
public class Tests_002
{
    ...
    [Test]
    public void ValidateRacerProperties()
    {
        var type = GetType("Racer");

        var properties = new[]
        {
            new Property(typeof(string), "Username", "Private"),
            new Property(typeof(string), "RacingBehavior", "Private"),
            new Property(typeof(int), "DrivingExperience", "Family"),
            new Property(GetType("ICar"), "Car", "Private"),
        };
